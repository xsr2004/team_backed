...
## 一些知识点
1.mybatis和mybatis-plus各自作用，项目的一般web架构，暴露的api等
2.Restful api
3.stream()和paralleStream()区别，为什么不用paralleStream
4.java处理跨域方案 @CrossOrigin

1.转list的那个collect(Collectors.toList()) √
2.matchUser那里怎么再改改，不一定要groupby √ 851>1392 不优化了...

3.java后端 正则 处理校验逻辑 √

3.自动生成用户名 ：模版 游客+随机6位数 √
